...
{return IWCreatePhotocast("http://www.bryanczibesz.com/Bryan_Czibesz/Portfolio/Pages/Excavations_files/rss.xml",false);}
...
IWLayoutPhotoGrid('id2',new IWPhotoGridLayout(4,new IWSize(175,175),new IWSize(175,112),new IWSize(186,302),27,27,0,new IWSize(0,0)),new IWStrokeParts([{rect:new IWRect(-1,1,2,172),url:'Excavations_files/stroke.png'},{rect:new IWRect(-1,-1,2,2),url:'Excavations_files/stroke_1.png'},{rect:new IWRect(1,-1,172,2),url:'Excavations_files/stroke_2.png'},{rect:new IWRect(173,-1,2,2),url:'Excavations_files/stroke_3.png'},{rect:new IWRect(173,1,2,172),url:'Excavations_files/stroke_4.png'},{rect:new IWRect(173,173,2,2),url:'Excavations_files/stroke_5.png'},{rect:new IWRect(1,173,172,2),url:'Excavations_files/stroke_6.png'},{rect:new IWRect(-1,173,2,2),url:'Excavations_files/stroke_7.png'}],new IWSize(174,174)),imageStream,range,null,null,1.000000,{backgroundColor:'rgb(192, 192, 192)',reflectionHeight:0,reflectionOffset:2,captionHeight:100,fullScreen:1,transitionIndex:2},'../../Media/slideshow.html','widget1','widget2','widget3')});}
...
loadMozillaCSS('Excavations_files/ExcavationsMoz.css')
